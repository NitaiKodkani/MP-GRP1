...
module.exports = function(Chart) {
	...
	// Easing model adapted from Robert Penner's easing equations
...
module.exports = function(Chart) {
	...
	Chart.Tooltip = Chart.Element.extend({
		...
		determineAlignment: function(size) {
			...
			var lf, rf; // model to determine left, right alignment
			var olf, orf; // model to determine if left/right alignment causes tooltip to go outside chart
