                    ...
                    <div class="col-md-3">
                        <div class="panel panel-primary">
                            <div class="panel-heading">               
                                ...
                                <h3 class="panel-title">Add Marking Scheme</h3>
                            </div>
...
//	echo '<a href="#modalUpdateform" onClick="showModal(this)" class="btn btn-info btn-xs" data-id="'.$id.'" data-toggle="modal">Edit</a>';
    echo ' <a href="#modalMRangeGrade" onClick="showModal1(this)" class="btn btn-warning btn-xs" data-id="'.$id.'" data-toggle="modal">View Marking scheme</a>';
...
//MSK-000108
	...
	if(name1 == '' || admission_fee1 == ''){
        ...
        var xhttp = new XMLHttpRequest();//MSK-00111-Ajax Start
			...
			xhttp.open("GET", "../model/update_grade.php?id=" + Id1 + "&name="+name1 + "&admission_fee="+admission_fee1 + "&do="+do1, true);
