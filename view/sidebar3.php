      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="my_sons_profile.php"><i class="fa fa-circle-o"></i> My Son's Profile</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="my_sons_teacher.php"><i class="fa fa-circle-o"></i> My Son's Teachers</a></li>
            <li><a href="all_teacher3.php"><i class="fa fa-circle-o"></i> All Teachers</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="my_sons_subject.php"><i class="fa fa-circle-o"></i> My Son's Subjects</a></li>
            <li><a href="all_subject3.php"><i class="fa fa-circle-o"></i> All Subjects</a></li>
          </ul>
        </li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="all_timetable3.php"><i class="fa fa-circle-o"></i>All Timetables</a></li>
          </ul>
        </li>
         <li class="treeview">
          <a href="#">
