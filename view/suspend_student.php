...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Suspended Students</a></li>
        </ol>
	</section>
...
?>   
                                <tr>
                                    ...
                                    <td> 
       <!--MSK-00128 -->
       <a href="#" class="confirm-active btn btn-danger btn-xs" data-id="<?php echo $row['id']; ?>,<?php echo $row['index_number']; ?>">De-suspend</a>
       <!--MSK-00146 -->
       <a href="#modalviewform" onClick="showModal(this)" class="btn btn-primary btn-xs"  data-id="<?php echo $row['id']; ?>,<?php echo $row['index_number']; ?>" data-toggle="modal">View Student Details</a>
                                   </td>
                                </tr>
<?php } } ?>
                            </tbody>
  		...
  		<div class="modal-dialog">
    		<div class="modal-content">
				<div class="modal-header bg-primary">
        			...
        			<h4 class="modal-title" id="frm_title">Un-suspend Student?</h4>
      			</div>
