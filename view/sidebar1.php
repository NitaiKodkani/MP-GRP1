...
?>      
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info" style="vertical-align: center">
        	<p style="vertical-align: center"><?php echo $name; ?></p>
        </div>
      </div>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="my_teacher.php"><i class="fa fa-circle-o"></i> My Teachers</a></li>
            <li><a href="all_teacher1.php"><i class="fa fa-circle-o"></i> All Teachers</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="my_subject.php"><i class="fa fa-circle-o"></i> My Subjects</a></li>
            <li><a href="all_subject1.php"><i class="fa fa-circle-o"></i> All Subjects</a></li>
          </ul>
        </li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="all_timetable1.php"><i class="fa fa-circle-o"></i> All Timetables</a></li>
          </ul>
        </li>
         <li class="treeview">
          <a href="#">
