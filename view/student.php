                        				...
                        				<div class="col-xs-7">
                                            ...
                                            <div class="form-group" id="divPhone">
                                                ...
                                                <div class="col-xs-7" id="divPhone1">
                                                	<input type="text" class="form-control" id="phone" name="phone" placeholder="91-XXXXXXXXXX">
                                                </div> 
                                        	</div>  
                        				...
                        				<div class="col-xs-7">
                                            <div class="form-group" id="divGPhone">
                                                ...
                                                <div class="col-xs-7" id="divGPhone1">
                                                	<input type="text" class="form-control" id="g_phone" name="g_phone" placeholder="91-XXXXXXXXXX" >
                                                </div> 
                                        	</div>
...
$("form").submit(function (e){
	...
	if(g_photo == ''){
		...
		$('#divGPhoto1').addClass('has-feedback');
		$('#divGPhoto1').append('<span id="spanGPhoto" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="The image is required" ></span>');	
